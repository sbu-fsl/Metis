...
########### Figure 5: Input coverage for write sizes (4 hours) ###########
...
# Plot the figure
python3 plot-mcfs-input-write-sizes-4hours.py $CURRENT_PATTERN-$TERMTIME $INPUT_COORDS_FILE
...
###########
echo "Figure 5: Input coverage for write sizes (4 hours) done."
