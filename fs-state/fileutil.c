...
void __attribute__((constructor)) init()
{
    ...
    add_ts_to_logname(output_log_name, NAME_MAX, OUTPUT_PREFIX, "");
    add_ts_to_logname(error_log_name, NAME_MAX, ERROR_PREFIX, "");
    add_ts_to_logname(seq_log_name, NAME_MAX, SEQ_PREFIX, "");
