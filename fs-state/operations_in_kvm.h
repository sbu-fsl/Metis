...
#ifndef _OPERATIONS_IN_KVM_H
#define _OPERATIONS_IN_KVM_H
...
int mount_in_kvm(int fsidx, const char *source, const char *target, const char *filesystemtype, unsigned long mountflags, const char *data);
