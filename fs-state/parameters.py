...
"""
#create_open_flag = make_params_pml('create_open_flag', SpecialParameters(0o101, 0o301, 0o1101, 0o40101))

# Deleted 0o40101 for testFS testing as it doesn't support O_DIRECT
create_open_flag = make_params_pml('create_open_flag', SpecialParameters(0o101, 0o301, 0o1101))
